  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        _sliderWidth =
        constraints.hasBoundedWidth ? constraints.maxWidth*0.75 : 300.0;
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                HSVColor.fromAHSV(1, 0, 1, 0.5).toColor(),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (showContact.value >= 0.5) {
      ...
      path.quadraticBezierTo(
          center.dx, size.height-5, thumbPadding / 2, center.dy);

      path.lineTo(size.width - thumbPadding / 2, center.dy);

      path.quadraticBezierTo(
          center.dx, size.height-5, size.width + 0.0, size.height + 5.0);
